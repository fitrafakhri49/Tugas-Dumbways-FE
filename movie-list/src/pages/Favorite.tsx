...
export default function Favorites() {
    ...
    const favoriteMovieIds = [1,3,5];
    const favoriteMovies = movies.filter(movie => favoriteMovieIds.includes(Number(movie.id)));
    return (
        <div className="p-4">
            <h1 className="text-5xl mb-4 font-bold">Favorite Movies</h1>
